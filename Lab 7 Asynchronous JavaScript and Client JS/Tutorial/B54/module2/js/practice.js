...
async function getDataFromLoadTransactions() {
    // simulating a network call, or a database call, or a file read - all of these take time, and we don't want to block the rest of our program while waiting for them to finish.
    const transactions = await loadTransactions(true) //order the food [we promise to deliver it in 1 second]
    console.log(transactions);
}

console.time("getDataFromLoadTransactions");
getDataFromLoadTransactions();

console.log("Some other thing that takes a very short time, and should be executed");
console.log("Some other thing that takes a very short time, and should be executed");
console.log("Some other thing that takes a very short time, and should be executed");
console.log("Some other thing that takes a very short time, and should be executed");
console.log("Some other thing that takes a very short time, and should be executed");

console.timeEnd("getDataFromLoadTransactions");
