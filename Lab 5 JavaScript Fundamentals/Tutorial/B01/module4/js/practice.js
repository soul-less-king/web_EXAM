...
console.log("Changed - My Module 4 JS is loaded!");
...
const allAmounts = document.querySelectorAll("div>p")
...
balanceDisplay.textContent = "5678910"

// document.querySelector("#output1").textContent = "Amro"

const countries = ["Qatar", "bahrain", "Saudi"]
...
balanceDisplay.classList.add("strike")
