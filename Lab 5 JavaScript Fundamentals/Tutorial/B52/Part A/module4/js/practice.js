...
// console.log("My javascript is loaded successfully");
...
const income = parseInt(incomeDisplay.textContent);
const expenses = parseInt(expensesDisplay.textContent);

balanceDisplay.textContent = formatCurrency(income - expenses);
...
// incomeDisplay.classList.add("strike");

// how to read x = balanceDisplay.textContent
// balanceDisplay.textContent = "new content"

console.log(balanceDisplay.textContent);


const amountClass = document.querySelectorAll(".amount")
