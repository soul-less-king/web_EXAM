...
const runningBalanceDisplay = document.querySelector("#running-balance");
...
addIncomeBtn.addEventListener('click', increase)

amountInput.addEventListener('input', displayPreview)

function increase() {
   const amount = parseInt(runningBalanceDisplay.textContent)
   runningBalanceDisplay.textContent = amount + 1000
}
