...
resetBtn.addEventListener('click', function () {
   const runningBalance = document.querySelector("#running-balance")
   runningBalance.textContent = "0 QAR"
})
...
function increment() {
   const runningBalance = document.querySelector("#running-balance")
   runningBalance.textContent = parseInt(runningBalance.textContent.replace('QAR', '')) + 1000 + " QAR"
}
